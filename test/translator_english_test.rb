...
class TranslatorEnglishTest < Minitest::Test
  ...
  def test_translates_a_single_letter
    ...
    result_1 = t.translates_top_line_from_english_to_braille("a")
    result_2 = t.translates_middle_line_from_english_to_braille("a")
    result_3 = t.translates_bottom_line_from_english_to_braille("a")
